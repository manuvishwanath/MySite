const myWork = [
    ...
    {
        name: 'LG-CNS Global Solutions Pvt Ltd',
        date: 'Jan-2013 to Jun-2013',
        desc: 'A sister company of LG INDIA. Mainly working towards product research and future innovations',
        domain: 'Retail and Marketing'
    },
    {
        name: 'GENPACT Pvt Ltd',
        date: 'Aug-2010 to Dec-2012',
        desc: 'A marketing and retail oriented company, providing market insights and client specific market predictions',
        domain: 'Retail and Marketing'
